...
<div class="list-group">
  ...
  <%
     ...
     {
  %>
  <a href="#" onclick="getAllPost(<%=c.getId()%>,this)" class="list-group-item list-group-item-action c-link"><%=c.getName()%></a>
  <%
    }
  %>
</div>
